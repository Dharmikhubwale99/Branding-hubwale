<div class="p-6 max-w-7xl mx-auto bg-white rounded shadow overflow-x-auto">
                ...
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">
                        <div class="flex flex-wrap gap-2">
                            @if ($video->status !== 'proccess' && $video->status !== 'approved')
    ...
    {{-- Edit Modal --}}
    @if ($editing)
        <div class="fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm z-40 flex items-center justify-center">
            <div class="bg-white rounded-lg p-6 shadow-xl z-50 w-full max-w-md">
                ...
                <textarea wire:model.defer="editDescription" rows="4" class="w-full border rounded px-3 py-2"></textarea>
