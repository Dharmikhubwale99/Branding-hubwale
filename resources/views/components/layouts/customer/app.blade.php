...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('icon/Branding_Hubwale_Final_01.jpg') }}">
...
<body class="bg-gray-50 text-gray-800">
    <div class="page-loader" id="pageLoader">
        <img src="{{ asset('icon/Branding_Hubwale_Final_01.jpg') }}" alt="Logo" class="loader-logo">
    </div>

    @include('components.layouts.customer.navbar')
    ...
    @include('components.layouts.customer.footer')
